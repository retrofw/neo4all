...
u32 CZ80_FASTCALL Cz80_Read_Dummy(const u32 adr);
void CZ80_FASTCALL Cz80_Write_Dummy(const u32 adr, u32 data);

s32 CZ80_FASTCALL Cz80_Interrupt_Ack_Dummy(s32 param);
void CZ80_FASTCALL Cz80_RetI_Dummy();
